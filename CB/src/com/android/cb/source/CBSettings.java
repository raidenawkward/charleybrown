...
public class CBSettings {
	...
	public static final String CB_SETTINGS_FILE_PATH = "/sdcard/lacarte/settings/app_settings.xml";
	...
	static {
		SETTINGS_MAP.put(CB_SETTINGS_DEVICE_ID, "PAD_UNKNOWN");
		SETTINGS_MAP.put(CB_SETTINGS_XML_ENCODING, "gb2312");
		SETTINGS_MAP.put(CB_SETTINGS_SOURCE_DIR, "/sdcard/lacarte");
		SETTINGS_MAP.put(CB_SETTINGS_SOURCE_DIR_DISHES, "/sdcard/lacarte/dishes");
		SETTINGS_MAP.put(CB_SETTINGS_SOURCE_DIR_ORDERS, "/sdcard/lacarte/orders");
		SETTINGS_MAP.put(CB_SETTINGS_SOURCE_DIR_SETTINGS, "/sdcard/lacarte/settings");
		SETTINGS_MAP.put(CB_SETTINGS_LEFT_BUTTONS_TAGS_FILE, "/sdcard/lacarte/settings/left_buttons.xml");
		SETTINGS_MAP.put(CB_SETTINGS_ORDER_LOCATIONS_FILE, "/sdcard/lacarte/settings/order_locations.xml");
