...
public class CBOrderedListView extends ListView {
	...
	public class ListAdapter extends ArrayAdapter<CBOrder.OrderedItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			listItemView.getViewPrice().setText(mOrderedListView.getContext().getResources().getString(R.string.ordering_label_price)
							+ String.valueOf(orderedItem.item.getDish().getPrice()));
			listItemView.getViewCount().setText(mOrderedListView.getContext().getResources().getString(R.string.ordering_label_count)
							+ orderedItem.count);
